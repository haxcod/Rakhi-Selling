...
const AdminPanel = () => {
  ...
  const [orders, setOrders] = useState([
    {
      ...
      items: [
        {
          productId: 1,
          productName: "Traditional Bhaiya Rakhi",
          quantity: 2,
          price: 149,
        },
        {
          productId: 2,
          productName: "Designer Gold Rakhi",
          quantity: 1,
          price: 299,
        },
      ],
    ...
    },
    {
      ...
      items: [
        {
          productId: 3,
          productName: "Kundan Pearl Rakhi",
          quantity: 3,
          price: 199,
        },
      ],
  ...
  const toggleStockStatus = async (id,currentStock) => {
    ...
    try{
      const newStock = currentStock === 0 ? Math.floor(Math.random() * 16) + 5 : 0;
  ...
  useEffect(() => {
    fetchProducts();
  }, [fetchProducts, handleAddProduct, handleDeleteProduct]);
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex space-x-2">
                      ...
                      >
                        ...
                        <span>
                          {productStockLoading ? "Waiting.." : product.stock === 0
                            ? "Out Stock"
                            : "In Stock"}
                        </span>
                      </button>
