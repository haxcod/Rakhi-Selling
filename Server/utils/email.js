...
const sendConfirmEmail = async ({ status, email, name, orderId, items, total, paymentMethod, address }) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: `🎉 Your BandhanBliss Order Has Been ${status}`,
    html: `
      <div style="font-family: Arial, sans-serif; color: #333;">
       ...
       ${orderId && <p>Your order <strong>#${orderId}</strong> has been received and is being processed.</p>}
